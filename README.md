...
<h1>Site Map</h1>
website starts on the home page it is expected that viewer just goes through the links one buy but the order dosent matter to much. The general flow though is:
  <ol>
  <li>homepage</li>
  <li>aboutme</li>
  <li>skills</li>
